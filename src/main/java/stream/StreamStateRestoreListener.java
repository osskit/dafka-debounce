...
public class StreamStateRestoreListener implements StateRestoreListener {
    ...
    public void onRestoreStart(
        ...
        logger.info(
            "Starting to restore State for topic {}, partition {} into store {}",
    ...
    public void onBatchRestored(
        ...
        logger.info(
            "Restored batch in State for topic {}, partition {} into store {}, number restored {}",
            topicPartition.topic(),
            topicPartition.partition(),
            storeName,
            numRestored
    ...
    public void onRestoreEnd(TopicPartition topicPartition, String storeName, long totalRestored) {
        logger.info(
            "Finished restoring State for topic {}, partition {} into store {}, total restored {}",
            topicPartition.topic(),
            topicPartition.partition(),
            storeName,
            totalRestored
