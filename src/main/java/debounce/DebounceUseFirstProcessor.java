...
public class DebounceUseFirstProcessor extends BaseDebounceProcessor {
    ...
    protected DebounceUseFirstProcessor(String storeId, int windowSize, PartitioningKeyResolver partitioningKeyResolver) {
        super(storeId, windowSize, partitioningKeyResolver);
    }

    @Override
    public Record<String, JsonNode> selectRecordToPutInWindow(Record<String, JsonNode> oldRecord, Record<String, JsonNode> newRecord) {
        return oldRecord;
    }
}
